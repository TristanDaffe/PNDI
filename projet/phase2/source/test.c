...
void main() {
	...
	displayResultsByClass(realClasses, estimateClasses, 20);
	printf("\n\n");
	displayAccuracy(realClasses, estimateClasses, 20);
	printf("\n\n");
	displayConfusionMatrix(realClasses, estimateClasses, 19); 
}
